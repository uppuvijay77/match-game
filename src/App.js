...
import ThumbnailItem from './components/ThumbnailItem/index'
import './App.css'
...
class App extends Component {
  ...
  onClickThumbnail = id => {
    ...
    if (randomImage.id === id) {
      ...
      this.setState({isMatched: false, sec: 0})
    }
  }
  ...
  render() {
    const {activeTabId, randomImage, isMatched, score, sec} = this.state
        ...
        {sec === 0 || isMatched === false ? (
          <div className="result-container">
            <img
              ...
              alt="trophy"
            />
            <p className="result-yourscore-text">Your Score</p>
